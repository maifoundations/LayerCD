...
class BlockCollection(nn.Module):
    ...
    def __init__(self, config: FullMolmoConfig):
        ...
        self.select_layer = len(self.resblocks)
...
class Molmo(nn.Module):
    ...
    def forward(
        ...
        if images is not None:
            ...
            # cls_embed: (batch_size, num_image, d_model)
            image_features, cls_embed = self.vision_backbone(images, image_masks) # NOTE
...
class MolmoForCausalLM(PreTrainedModel):
    ...
    def forward(
        ...
        images_vcd: Optional[torch.FloatTensor] = None,
        cd_beta: Optional[torch.FloatTensor] = None,
        cd_alpha: Optional[torch.FloatTensor] = None,
        vcd: Optional[bool] = False,
        hcd: Optional[bool] = False,
        noise_step: Optional[int] = 500,
        model_type: Optional[str] = 'LLaVA',
