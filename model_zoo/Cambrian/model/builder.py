...
import torch
from model_zoo.Cambrian.constants import DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN

from ezcolorlog import root_logger as logger

from model_zoo.Cambrian.model.language_model.cambrian_llama import CambrianLlamaForCausalLM
from model_zoo.Cambrian.model.language_model.cambrian_mistral import CambrianMistralForCausalLM
from accelerate import infer_auto_device_map, dispatch_model


def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda", use_flash_attn=False, **kwargs):
    device_map='sequential'
    kwargs = {"device_map": device_map, "max_memory":{0: "8GIB", 1: "24GIB", 2: "24GIB", 3: "24GIB"}, **kwargs}
    ...
    if 'cambrian' in model_name.lower():
        ...
        if 'lora' in model_name.lower() and model_base is not None:
            from model_zoo.Cambrian.model.language_model.cambrian_llama import CambrianConfig
